...
| 版本 | 日期 | 内容 |
|------|------|------|
| v10 | 2026-06 | 外接 ILI9341 屏幕 (320×240) |
| v9 | 2026-06 | 选词跳查（Ctrl 触发）|
| v8 | 2026-06 | 性能优化（PSRAM + 字体懒加载）|
| v7 | 2026-06 | 字形自定义工具链（font_editor.html）|
| v6 | 2026-06 | 修复 senses_multiple 漏抓首义项 |
| v5 | 2026-06 | 左右键切词典前后词 |
| v4 | 2026-06 | 段驱动标记流 + 状态栏改造 |
| v3 | 2026-06 | 实机验证后迭代（11 个 bug 修复）|
| v1–v2 | 2026-06 | 初版 + 字体策略调整 |
